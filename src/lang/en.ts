export default {
  ...
  node: {
    nodeList: {
      nodeNetwork: 'Node access to the network',
      add: 'Add a Node',
      rest: 'Rest',
      name: 'Name',
      namePlaceholder: 'Please enter the name',
      number: 'Number',
      numberPlaceholder: 'Please enter the number',
      type: 'Type',
      typePlaceholder: 'Please select the type',
      currency: 'Currency',
      currencyPlaceholder: 'Please select the currency',
      rate: 'Rate',
      ratePlaceholder: 'Please select the rate',
      address: 'Address',
